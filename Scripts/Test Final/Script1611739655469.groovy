...
Mobile.callTestCase(findTestCase('Test D'), [:], FailureHandling.STOP_ON_FAILURE)
...
MobileElement LanjutkanDaftar = driver.findElementByAndroidUIAutomator('new UiSelector().className("android.view.View").index(4)')
LanjutkanDaftar.click()

Mobile.delay(5)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Lanjutkan (4)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (8)'), '5', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (9)'), '5', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (10)'), '2', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (11)'), '4', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (12)'), '1', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (13)'), '2', 0)
